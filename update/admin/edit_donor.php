                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username"  value="<?php  echo $data['username']?>"placeholder="أدخل الاسم الكامل" >
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label for="birthdate">تاريخ الميلاد</label>
                            <input type="date" id="birthdate" name="birthdate" value="<?php echo $birthdate_formatted; ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="con" name="con" placeholder="أدخل رقم الهاتف" value="<?php  echo $data['con']?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="Fgroup" name="Fgroup" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="time" id="time" name="time" value="<?php  echo $data['time']?>"  required>
                        </div>
                    </div>
                </div>
