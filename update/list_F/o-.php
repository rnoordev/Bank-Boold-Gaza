...
<title>فصيلة الدم O+ - بنك الدم غزة</title>
<link rel="stylesheet" href="../css/style.css">
<link rel="stylesheet" href="../css/app.css">

<meta name="description" content="بنك الدم في غزة - تبرع بالدم وأنقذ حياة">

<meta property="og:title" content="فصيلة الدم O+ - بنك الدم غزة">
...
<div class="container">
  ...
  <div class="blood-banner">
    <h2>فصيلة الدم O-</h2>
    <p>يمكن لأصحاب فصيلة O+ التبرع لجميع الفصائل الموجبة (A+، B+، AB+، O+)، ويمكنهم استقبال الدم من فصائل O+ و O- فقط</p>
  </div>

  <div class="table-container">
    <h3 class="table-title">قائمة المتبرعين من فصيلة O-</h3>
